...
|:----------------|----------:|------------:|-----------------:|--------:|
| Springfield (S) |           | 1,045       | 876              | 2,673   |
|	Gotham City (G) | 2,893     | 2,504       | 1,803            |         |
|	**Sum**         | 3,645     |             | 2,706            | 9,900   |


Complete the above table: 

Frequency$("Springfield" \cap "Enjoy")=$ `r fitb(752)`

Frequency$("Neutral")=$ `r fitb(3549)`

Frequency$("Gotham~City")=$ `r fitb(7227)`

Now calculate the probability table (to 4dp:

| City            | Enjoy (E) | Neutral (N) | Do not enjoy (D) | **Sum** |
|:----------------|----------:|------------:|-----------------:|--------:|
| Springfield (S) | `r fitb(0.0760)`|`r fitb(0.1056)` | `r fitb(0.0885)` | `r fitb(0.2700)`  |
|	Gotham City (G) | `r fitb(0.2922)`| `r fitb(0.2529)`| `r fitb(0.1848)` |`r fitb(0.7300)`|
|	**Sum**         | `r fitb(0.3682)`|`r fitb(0.3585)`| `r fitb(0.2733)` | `r fitb(1.000)`|
